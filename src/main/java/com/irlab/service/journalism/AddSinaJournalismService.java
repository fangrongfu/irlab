 ...
 * @author fangrongfu
 * @version 1.0
 * @date 2017年10月9日上午11:17:13
 */
public class AddSinaJournalismService implements PageProcessor {
	...
	public static void main(String[] args) {
		...
		Spider.create(new AddSinaJournalismService()).addUrl("http://finance.sina.com.cn/").thread(5).run();
	}
