 ...
 * @author  fangrongfu
 * @version 1.0
 * @date    2017年10月9日下午1:20:31
 */
public class AddYearSinaNotice implements PageProcessor{
	...
	public static void main(String[] args) {
		...
		for(Firm firm :f) {
			String url = "http://vip.stock.finance.sina.com.cn/corp/go.php/vCB_Bulletin/stockid/";
			String urlN = url.concat(firm.getF_code()).concat("/page_type/ndbg.phtml");
			//年度报告
			Spider.create(new AddYearSinaNotice()).addUrl(urlN).thread(5).run();
		}
	}
