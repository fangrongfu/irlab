 ...
 * @author  fangrongfu
 * @version 1.0
 * @date    2017年10月9日下午12:59:33
 */
public class AddYSinaNotice implements PageProcessor {
	...
	public static void main(String[] args) {
		...
		for (Firm firm : f) {
			String url = "http://vip.stock.finance.sina.com.cn/corp/go.php/vCB_BulletinYi/stockid/";
			String urlY = url.concat(firm.getF_code()).concat("/page_type/yjdbg.phtml");
			// 一季度报告
			Spider.create(new AddYSinaNotice()).addUrl(urlY).thread(5).run();
		}
	}
